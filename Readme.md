# JustCode - React Native Zero to Hero Tutorial 7
Hi! Welcome to JustCode React Native Zero to Hero Tutorial 7 Github page. To run the application in this Github page you need to:
